...
int main(void){
    int i;  //ループカウンタ
    //動作確認用の昇順リスト
    int list_array1[9] = {0, 2, 2, 3, 4, 6, 7, 9, 10};
    int list_array2[8] = {1, 2, 4, 5, 6, 7, 8, 10};
    // int list_array3[12] = {1, 2, 3, 11, 12, 4, 5, 8, 9, 6, 7, 10};
    struct node head1_p0, head2_p0, head3_p0;  //ダミー
    struct node *head1=&head1_p0, *head2=&head2_p0, *tmp;
    // struct node *head3 = &head3_p0; //先頭のポインタ
    ...
    // tmp = head3;
    // for (i = 0; i < 12; i++){
    // tmp = insert_after(list_array3[i], tmp);
    // }
    // printf("list:");
    // print_whole_list_GP(head3);
    // naturalsort(head3);
    // printf("result ");
    // print_whole_list_GP(head3);
    return 0;
